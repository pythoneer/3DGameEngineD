...
class Texture
{
	...
	public this(string fileName, GLenum textureTarget = GL_TEXTURE_2D, GLint filter = GL_LINEAR, GLenum internalFormat = GL_RGBA8, GLenum format = GL_BGRA, bool clamp = false, GLenum attachment = GL_NONE)
 	{
 	...
 	this(int width, int height, ubyte* data, GLenum textureTarget, GLint filter, GLenum internalFormat = GL_RGBA, GLenum format = GL_RGBA, bool clamp = false,  GLenum attachment = GL_NONE) 
 	{
 		this.fileName = "";
